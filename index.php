...
<html lang="en" data-bs-theme="auto">
  <head>
    ...
    <title>MyAnytimeChart.com</title>
...
<main>
  <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-body-tertiary">
    <div class="col-md-6 p-lg-5 mx-auto my-5">
      <h1 class="display-3 fw-bold">MyAnyTimeChat</h1>
      <h3 class="fw-normal text-muted mb-3">Chat with your firends without worrrying about the chat logs. Now you can greely chat your fiends using our free platform.</h3>
    <form action="claim.php" method="post">
    MyAnyTimeChart.com/<input type="text" name="room">
